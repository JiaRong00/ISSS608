...
In this exercise, we will be using a personal database in Microsoft Access mdb format called Coffee Chain and load the following packages: lubridate, ggthemes, reactable,
