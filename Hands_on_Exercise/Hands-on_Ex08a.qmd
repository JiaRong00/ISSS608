...
In this exercise, we will plot functional and truthful choropleth maps by using an R package called tmap package.

### **2 Getting Started**

In this exercise, we wil use 2 datasets: (1) Master Plan 2014 Subzone Boundary (Web) (i.e. MP14_SUBZONE_WEB_PL) in ESRI shapefile format. It can be downloaded at data.gov.sg This is a geospatial data. It consists of the geographical boundary of Singapore at the planning subzone level. The data is based on URA Master Plan 2014.
...
he following data wrangling and transformation functions will be used:
...
#### **4.5 Drawing Small Multiple Choropleth Maps**
...
##### **4.5.1 By assigning multiple values to at least one of the aesthetic arguments**
...
##### **4.5.2 By defining a group-by variable in tm_facets()**
...
##### **4.5.3 By creating multiple stand-alone maps with tmap_arrange()**
...
#### **4.6 Mappping Spatial Object Meeting a Selection Criterion**
